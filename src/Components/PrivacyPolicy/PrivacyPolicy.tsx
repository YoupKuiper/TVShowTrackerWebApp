...
function PrivacyPolicy() {
	return (
		<div className="py-20 px-40">
			...
			<p>
				Youp Kuiper built the TV tracker app as a Free app. This SERVICE is provided by Youp Kuiper at no cost
			...
			<p>
				...
				accessible at TV tracker unless otherwise defined in this Privacy Policy.
			</p>{" "}
			<p>
			...
			<p>
				...
				personally identifiable information, including but not limited to email address, firebase device id. The
			...
			<p>This policy is effective as of 2023-01-20</p>{" "}
			<p>
				<strong>Contact Us</strong>
			</p>{" "}
			<p>
				If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at
				youpkuiper@gmail.com.
			</p>{" "}
			<p>
